...
// ─── Main Page ──────────────────────────────────────────────
/**
 * The Calling workspace: eight tabs over one client-side state closure.
 *
 * It lives here rather than in page.tsx so the route itself can be a Server
 * Component and read the tab from the query string. The employee shell renders
 * this component directly rather than importing the facility route's default
 * export, which is what it did until 2026-09-01 — that coupling only worked
