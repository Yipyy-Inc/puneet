...
// ============================================================================
// Settings → daycare goes STRAIGHT to the module's own settings.
//
// This route used to render an interstitial: one card whose only content was a
// link reading "Open daycare settings →", and a calendar-colour picker. Two
...
// deleted, so the rail entry, the index card, a bookmark and `?section=daycare`
// all land in the same place.
// ============================================================================

export default function Page() {
  redirect("/facility/dashboard/services/daycare/settings");
}
