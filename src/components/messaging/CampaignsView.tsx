...
function CampaignWizard({ onClose }: { onClose: () => void }) {
  ...
  const send = () => {
    toast.success(
      `Campaign "${name}" ${scheduleMode === "now" ? "sent" : "scheduled"}!`,
    );
    onClose();
  };
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Select how you want to reach your clients.
              </p>
            </div>
        ...
        {step === 2 && (
          <div className="space-y-4">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Filter which clients will receive this campaign.
              </p>
            </div>
            ...
            {recipientCount > 0 && (
              <div className="flex items-center gap-2 rounded-xl bg-blue-50 px-4 py-2.5 text-sm text-blue-700">
                ...
                <strong>{recipientCount} recipients</strong> will receive this
                campaign
              </div>
            )}
          </div>
              ...
              <div className="flex flex-wrap gap-1.5">
                {VARIABLES.map((v) => (
                  <button
                    ...
                    className="rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1 font-mono text-[11px] text-slate-600 hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700"
                  >
                    {v}
                  </button>
                ))}
            ...
            {channel === "sms" && message.length > 0 && (
              <div className="flex items-center gap-3 rounded-xl bg-slate-50 px-4 py-2.5 text-sm text-slate-600">
                ...
                <span>
                  ...
                  <strong>{segments}</strong> SMS segment
                  {segments !== 1 ? "s" : ""} ·{" "}
            ...
            <div className="divide-y divide-slate-100 rounded-2xl border border-slate-200">
              {[
                ...
                channel === "sms"
                  ? {
                      label: "Est. Cost",
                      value: `$${smsCost} (${segments} seg × ${recipientCount})`,
                    }
                  : null,
              ]
                .filter(Boolean)
        ...
        {[
          ...
          <Card key={kpi.label}>
            <CardContent className="pt-5">
              ...
              <p className={cn("mt-1 text-3xl font-bold", kpi.color)}>
                {kpi.value}
              </p>
            </CardContent>
          </Card>
        ...
        <DialogContent className="max-w-2xl overflow-hidden p-0">
          <div className="border-b px-6 py-4">
            ...
            <p className="text-sm text-slate-500">
              Create a targeted SMS or email campaign
            </p>
          </div>
