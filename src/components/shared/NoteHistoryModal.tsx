...
export function NoteHistoryModal({
  ...
  return (
    <Modal
      ...
      size="md"
    >
      <div className="space-y-4" role="region" aria-label={t("editHistory")}>
        {/* Current version */}
        ...
        <ol className="list-none space-y-0" aria-label={t("previousVersions")}>
              ...
              <div className="pb-4">
                <div className="mb-1 flex items-center gap-2">
                  ...
                  <span className="text-muted-foreground text-xs">
                    {formatNoteDate(edit.editedAt, locale)}
                  </span>
                </div>
