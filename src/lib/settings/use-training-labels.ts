...
// ============================================================================
// The three label tables the training settings screen reads out of a fixture.
//
// ── WHY THESE NEED A HOOK AT ALL ─────────────────────────────────────────
//
// A module-level constant cannot call a hook, so it cannot know a locale. All
// three of these are plain objects in `src/data` or `src/lib`, and all three are
...
// in each of the three render sites.
//
// ── THE KEY IS WHAT TRAVELS ──────────────────────────────────────────────
//
// `difficultyLevel`, `MilestoneKind` and `ReportCardSendMode` are all STORED
// and matched. Only the label moves. Every resolver falls back
