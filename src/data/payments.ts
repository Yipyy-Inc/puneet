...
export const invoices: Invoice[] = [
  ...
  },
  {
    ...
    items: [
      {
        id: "item-012",
        description: "Grooming - Full Groom (Whiskers)",
        quantity: 1,
        unitPrice: 80,
        total: 80,
        taxable: true,
    ...
    createdBy: "Mike Davis",
    createdById: 2,
    sentAt: "2026-02-01T09:05:00Z",
    reminderSentAt: "2026-02-20T09:30:00Z",
    reminderCount: 1,
    notes: "Auto-reminder sent for overdue grooming invoice",
  },
  {
    id: "inv-012",
    ...
    items: [
      {
        id: "item-013",
        description: "Boarding - 2 Nights (Buddy)",
        quantity: 2,
        unitPrice: 75,
        total: 150,
        taxable: true,
