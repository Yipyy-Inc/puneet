...
const bookingSeeds: Booking[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    invoice: {
      ...
      total: 195.46,
      depositRequired: 58.64,
      depositRuleLabel: "Boarding — 30% deposit",
      depositCollected: 0,
      remainingDue: 195.46,
      payments: [],
      auditTrail: [
        {
          ...
          description: "Invoice created from boarding booking",
        ...
        },
        {
          id: "evt-10001-2",
          type: "item_added",
          description: 'Add-on "Video Call" added',
          ...
          snapshot: {
            ...
            taxAmount: 23.21,
            taxes: [
              { name: "GST", rate: 0.05, amount: 7.75 },
              { name: "QST", rate: 0.09975, amount: 15.46 },
            ],
            total: 178.21,
            depositRequired: 53.46,
            depositCollected: 0,
            remainingDue: 178.21,
            payments: [],
          },
        },
        {
          id: "evt-10001-3",
          type: "item_added",
          description: 'Add-on "Enrichment Session" added',
          timestamp: "2026-04-03T15:00:00Z",
          staffName: "Jake M.",
          itemName: "Enrichment Session",
          amount: 15,
          note: "Extra play time requested by owner",
          snapshot: {
            status: "estimate",
            items: [
              {
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    invoice: {
      ...
      total: 103.48,
      depositRequired: 25,
      depositRuleLabel: "Grooming — $25 deposit",
      depositCollected: 45,
      depositCollectedBy: "Amy C.",
      depositCollectedAt: "2026-04-01T10:15:00Z",
      remainingDue: 28.48,
      payments: [
        {
          date: "2026-04-01",
        ...
        },
        {
          ...
          kind: "prepayment",
          collectedBy: "Sarah K.",
          note: "Owner prepaid before pickup",
        },
      ],
    },
  },
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    invoice: {
      ...
      total: 224.2,
      depositRequired: 67.26,
      depositRuleLabel: "Boarding — 30% deposit",
      depositCollected: 50,
      depositCollectedBy: "Sarah K.",
      depositCollectedAt: "2026-03-08T14:30:00Z",
      remainingDue: 0,
      payments: [
        {
          date: "2026-03-08",
      ...
      auditTrail: [
        ...
        },
        {
          ...
          description: "Deposit collected via card",
        ...
        },
        {
          id: "evt-10005-3",
          type: "status_changed",
          description: "Invoice opened — pet checked in",
        ...
        },
        {
          ...
          description: "Final payment processed via card",
        ...
        },
        {
          id: "evt-10005-5",
          type: "invoice_closed",
          description: "Invoice closed — paid in full",
          timestamp: "2026-03-13T11:31:00Z",
          staffName: "Amy C.",
          snapshot: {
            status: "closed",
            items: [
  ...
  // ═══════════════════════════════════════════════════════════════════
  // #23 — Daycare: Rocky (Lisa Wilson, client 17, pet 5)
  // ═══════════════════════════════════════════════════════════════════
  {
    id: 23,
    clientId: 17,
    ...
    invoice: {
      ...
      depositCollected: 0,
      remainingDue: 0,
      payments: [{ date: "2024-03-10", method: "Credit Card", amount: 36.79 }],
    },
  },

  // ═══════════════════════════════════════════════════════════════════
  // #24 — Daycare: Daisy (Robert Taylor, client 18, pet 6)
  // ═══════════════════════════════════════════════════════════════════
  {
    id: 24,
    clientId: 18,
    ...
    invoice: {
      ...
      depositCollected: 0,
      remainingDue: 0,
      payments: [{ date: "2024-03-10", method: "Debit", amount: 25.29 }],
    },
  },

  // ═══════════════════════════════════════════════════════════════════
  // #25 — Grooming: Cooper (Jennifer White, client 19, pet 7)
  // ═══════════════════════════════════════════════════════════════════
  {
    id: 25,
    clientId: 19,
    ...
    totalCost: 43,
    paymentStatus: "paid",
    stylistPreference: "Jessica Martinez",
    notificationEmail: true,
    notificationSMS: false,
    invoice: {
      id: "10025",
      ...
      taxAmount: 6.44,
      taxes: [
        { name: "GST", rate: 0.05, amount: 2.15 },
        { name: "QST", rate: 0.09975, amount: 4.29 },
      ],
      total: 49.44,
      depositCollected: 0,
      remainingDue: 0,
      payments: [{ date: "2024-03-10", method: "Credit Card", amount: 49.44 }],
    },
  },

  // ═══════════════════════════════════════════════════════════════════
  // #26 — Grooming: Milo (Amanda Clark, client 20, pet 8)
  // ═══════════════════════════════════════════════════════════════════
  {
    id: 26,
    clientId: 20,
    ...
    totalCost: 55,
    paymentStatus: "pending",
    stylistPreference: "Sophie Laurent",
    notificationEmail: true,
    notificationSMS: true,
    invoice: {
      id: "10026",
      ...
      taxAmount: 8.24,
      taxes: [
        { name: "GST", rate: 0.05, amount: 2.75 },
        { name: "QST", rate: 0.09975, amount: 5.49 },
      ],
      total: 63.24,
      depositCollected: 0,
      remainingDue: 63.24,
