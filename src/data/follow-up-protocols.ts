...
export const followUpProtocols: FollowUpProtocol[] = [
  {
    ...
    steps: [
      ...
      {
        id: "step-injury-care-1",
        order: 4,
        title: "Monitor & clean the wound",
        description: "Check and clean the injury during in-stay care.",
        instructions:
          "Inspect the site, clean with antiseptic, watch for swelling or discharge.",
        daysAfterIncident: 0,
        hoursAfterIncident: 0,
        contactMethod: "in_person",
        assigneeRole: "any_staff",
        questionsToAsk: [],
        requiresPhoto: true,
        requiresClientResponse: false,
        stepType: "in_stay_care",
        careActionName: "Monitor & clean the wound",
        frequency: "twice_daily",
        duration: "until_checkout",
        starts: "immediately",
        staffInstructions:
          "Inspect the site, clean with antiseptic, watch for swelling or discharge. Attach a photo each check.",
      },
    ],
  },
  {
