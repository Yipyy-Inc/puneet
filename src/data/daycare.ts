...
export const daycareCheckIns: DaycareCheckIn[] = [
  ...
  // Scheduled arrivals for today (not yet checked in)
  {
    ...
    checkInTime: "2026-07-19T09:00:00",
    checkOutTime: null,
    scheduledCheckOut: "2026-07-19T17:00:00",
    rateType: "full-day",
    status: "scheduled",
    notes: "Regular. Prefers the medium play group.",
    playGroup: "Medium Dogs",
    photoUrl: "/pets/cooper.jpg",
  },
  {
    id: "dc-009",
    petId: 7,
    ...
    checkInTime: "2026-07-19T08:30:00",
    checkOutTime: null,
    scheduledCheckOut: "2026-07-19T13:00:00",
    rateType: "half-day",
    status: "scheduled",
    notes: "Half day. Gentle with small dogs.",
    playGroup: "Small Dogs",
    photoUrl: "/pets/milo.jpg",
  },
  {
    id: "dc-010",
    petId: 8,
    ...
    checkInTime: "2026-07-19T09:30:00",
    checkOutTime: null,
    scheduledCheckOut: "2026-07-19T17:00:00",
    rateType: "full-day",
    status: "scheduled",
    notes: "Loves the splash pool.",
    playGroup: "Medium Dogs",
    photoUrl: "/pets/rosie.jpg",
  },
  {
    id: "dc-011",
    petId: 20,
    ...
    checkInTime: "2026-07-19T08:00:00",
    checkOutTime: null,
    scheduledCheckOut: "2026-07-19T17:00:00",
    rateType: "full-day",
    status: "scheduled",
    notes: "High energy — large dog yard.",
    playGroup: "Large Dogs",
  ...
  },
  {
    ...
    checkInTime: "2026-07-19T10:00:00",
    checkOutTime: null,
    scheduledCheckOut: "2026-07-19T15:00:00",
    rateType: "half-day",
    status: "scheduled",
    notes: "First half-day booking of the week.",
    playGroup: "Small Dogs",
    photoUrl: "/pets/coco.jpg",
  },
];
