...
// `stylists` and `stylistAvailability` used to live here: five groomers with
// their own copies of name, email, phone and employment status, plus 18
// availability rows keyed to them.
//
// Both are gone. A groomer is a `staff` row with a
// `grooming_stylist_profiles` row attached (20260806500000), served by
// /api/grooming/stylists. The person is stored once.
//
// The mock's David Kim is why: it said `status: "on-leave"` while the staff
// roster said `inactive` -- two records of one person's employment,
...
export const groomingPackages: GroomingPackage[] = [
  {
    ...
    productUsage: [
      ...
      {
        productId: "prod-020",
        productName: "Q-Tips / Cotton Swabs",
        quantity: 5,
        unit: "count",
        isOptional: false,
      },
      {
        productId: "prod-006",
        productName: "Finishing Spray Cologne - Fresh Cotton",
        quantity: 3,
        unit: "ml",
        isOptional: true,
      },
  ...
  },
  {
    ...
    productUsage: [
      ...
      {
        productId: "prod-018",
        productName: "Eye Cleaning Solution",
        quantity: 4,
        unit: "ml",
        isOptional: false,
      },
      ...
      {
        productId: "prod-014",
        productName: "Bandanas - Assorted Colors",
        quantity: 1,
        unit: "count",
        isOptional: true,
      },
  ...
  },
  {
    ...
    purchaseCount: 189,
    createdAt: "2023-01-15",
    assignedStylistIds: ["stylist-001", "stylist-004"],
    requiresEvaluation: false,
    productUsage: [
      {
        productId: "prod-001",
      ...
      {
        productId: "prod-009",
        productName: "Paw Balm - Healing Formula",
        quantity: 5,
        unit: "g",
        isOptional: false,
      },
      ...
      {
        productId: "prod-015",
        productName: "Bows - Assorted Colors",
        quantity: 1,
        unit: "count",
        isOptional: true,
      },
  ...
  },
  {
    ...
    assignedStylistIds: ["stylist-003"],
    requiresEvaluation: false,
    productUsage: [
      {
        productId: "prod-002",
        productName: "Deep Clean Degreasing Shampoo",
        quantity: 40,
        unit: "ml",
        isOptional: false,
      },
...
export const groomingAppointments: GroomingAppointment[] = [
  {
    ...
    intake: {
      ...
      sessionStartedAt: new Date(Date.now() - 55 * 60 * 1000).toISOString(),
      issues: [
        {
          id: "iss-001",
          kind: "matting-found",
      ...
      careLog: [
        {
          ...
          administeredBy: "Jessica Martinez",
        },
        {
          id: "cl-med-001",
          kind: "medication",
    ...
    afterPhotos: [
      {
        ...
        url: "/pets/buddy.jpg",
        type: "after",
        caption: "Trimmed to summer length, coat brushed out.",
  ...
  },
  {
    ...
    history: [
      ...
      },
      {
        ...
        staff: "System",
        description: "Express Check-In form submitted by client",
      },
    ],
    expressCheckinSubmission: {
      ...
      answers: {
        ...
        "q-meds": false,
        "q-style": "Same as last time",
        "q-style-notes": "Please trim the paw pads short.",
      },
      photosFromClient: ["/pets/bella.jpg"],
      surchargeApprovals: [
        {
          id: "sa-002-matting",
          label: "De-matting fee",
          reason: "matting-fee",
          amount: 15,
          decision: "approved",
          decidedAt: new Date(Date.now() - 90 * 60_000).toISOString(),
        },
        {
          id: "sa-002-behavior",
          label: "Behavioral handling surcharge",
          reason: "behavioral-handling",
          amount: 20,
          decision: "declined",
          decidedAt: new Date(Date.now() - 90 * 60_000).toISOString(),
        },
  ...
  },
  {
    ...
    alertNotes: [
      {
        id: "alert-duke-1",
        text: "Nervous with nail work — muzzle required, go slow on the back paws.",
        createdBy: "Jessica Martinez",
  ...
  // ── Additional appointments for today, across groomers and statuses ─────────
  {
    id: "appt-101",
    date: getDateString(0),
    startTime: "08:30",
    ...
    totalPrice: 40,
    status: "checked-in",
    checkInTime: getDateString(0) + "T08:28:00",
    checkOutTime: null,
    notes: "Waiting for bath station.",
    specialInstructions: "",
    allergies: [],
    lastGroomDate: getDateString(-28),
    createdAt: getDateString(-3),
  ...
  },
  {
    ...
    petPhotoUrl: "/dogs/dog-4.jpg",
    ownerId: 46,
    ownerName: "Greg Palmer",
    ownerPhone: "(514) 555-0131",
    ownerEmail: "greg.palmer@email.com",
    stylistId: "stylist-001",
    stylistName: "Jessica Martinez",
    packageId: "groom-pkg-004",
    packageName: "Quick Tidy Up",
    ...
    totalPrice: 35,
    status: "completed",
    checkInTime: getDateString(0) + "T07:55:00",
    checkOutTime: getDateString(0) + "T08:32:00",
    notes: "Quick nail and tidy, in and out.",
    specialInstructions: "",
    allergies: [],
    lastGroomDate: getDateString(-14),
    createdAt: getDateString(-4),
  ...
  },
  {
    ...
    petWeight: 10,
    coatType: "long",
    petPhotoUrl: "/cats/cat-1.jpg",
    ownerId: 47,
    ownerName: "Isabelle Roy",
    ownerPhone: "(514) 555-0132",
    ownerEmail: "isabelle.roy@email.com",
    stylistId: "stylist-002",
    stylistName: "Amy Chen",
    packageId: "groom-pkg-003",
    packageName: "Spa Day Deluxe",
    ...
    checkOutTime: null,
    notes: "Long-haired cat, works best with breaks.",
    specialInstructions: "Cat-only quiet room.",
    allergies: [],
    lastGroomDate: getDateString(-40),
  ...
  },
  {
    ...
    checkInTime: getDateString(0) + "T09:25:00",
    checkOutTime: null,
    notes: "First groom — went great! Ready for pickup.",
    specialInstructions: "",
    allergies: [],
    createdAt: getDateString(-2),
    onlineBooking: true,
  },
  {
    ...
    petPhotoUrl: "/dogs/dog-3.jpg",
    ownerId: 49,
    ownerName: "Hannah Wright",
    ownerPhone: "(514) 555-0134",
    ownerEmail: "hannah.wright@email.com",
    stylistId: "stylist-003",
    stylistName: "Marcus Thompson",
    packageId: "groom-pkg-006",
    packageName: "De-Shedding Treatment",
    addOns: ["Furminator Treatment"],
    basePrice: 75,
    priceAdjustments: [],
    totalPrice: 75,
    status: "checked-in",
    checkInTime: getDateString(0) + "T10:55:00",
    checkOutTime: null,
    notes: "Heavy seasonal shed.",
    specialInstructions: "",
    allergies: [],
    lastGroomDate: getDateString(-33),
    createdAt: getDateString(-5),
    onlineBooking: true,
  },
  {
    ...
    petWeight: 18,
    coatType: "long",
    petPhotoUrl: "/cats/cat-2.jpg",
    ownerId: 50,
    ownerName: "Derek Shaw",
    ownerPhone: "(514) 555-0135",
    ownerEmail: "derek.shaw@email.com",
    stylistId: "stylist-003",
    stylistName: "Marcus Thompson",
    packageId: "groom-pkg-002",
    packageName: "Full Groom",
    ...
    totalPrice: 90,
    status: "completed",
    checkInTime: getDateString(0) + "T08:10:00",
    checkOutTime: getDateString(0) + "T09:50:00",
    notes: "Lion cut, owner very happy.",
    specialInstructions: "",
    allergies: [],
    lastGroomDate: getDateString(-60),
    createdAt: getDateString(-8),
  ...
  },
  {
    ...
    petWeight: 11,
    coatType: "short",
    petPhotoUrl: "/cats/cat-3.jpg",
    ownerId: 51,
    ownerName: "Priya Sharma",
    ownerPhone: "(514) 555-0136",
    ...
    totalPrice: 88,
    status: "ready-for-pickup",
    checkInTime: getDateString(0) + "T09:55:00",
    checkOutTime: null,
    notes: "Ready — owner texted, on the way.",
    specialInstructions: "",
    allergies: [],
    lastGroomDate: getDateString(-25),
    createdAt: getDateString(-3),
    onlineBooking: true,
  },
  {
    ...
    petPhotoUrl: "/dogs/dog-2.jpg",
    ownerId: 52,
    ownerName: "Megan Cole",
    ownerPhone: "(514) 555-0137",
    ownerEmail: "megan.cole@email.com",
    stylistId: "stylist-004",
    stylistName: "Sophie Laurent",
    packageId: "groom-pkg-001",
    packageName: "Basic Bath",
    ...
    checkInTime: null,
    checkOutTime: null,
    notes: "Afternoon bath and blow-dry.",
    specialInstructions: "",
    allergies: [],
    lastGroomDate: getDateString(-30),
    createdAt: getDateString(-1),
...
export const groomingProducts: GroomingProduct[] = [
  ...
  },
  {
    ...
    category: "health",
    description:
      "Gentle eye cleaning solution for tear stain and debris removal",
    sku: "VC-EYE-001",
    itemType: "consumable",
    measurementUnit: "ml",
    currentStock: 1200,
  ...
  // â”€â”€ Accessories & Consumables â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  {
    ...
    description: "Soft cotton pads for ear and eye cleaning during grooming",
    sku: "GP-PAD-001",
    itemType: "consumable",
  ...
  {
    id: "prod-020",
    name: "Q-Tips / Cotton Swabs",
    brand: "GroomPro",
    category: "accessories",
    description:
      "Cotton swabs for detail ear cleaning and precise product application",
    sku: "GP-QTIP-001",
    itemType: "consumable",
    measurementUnit: "count",
    currentStock: 180,
  ...
  // â”€â”€ Tools (non-consumable equipment) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  {
    ...
    category: "tools",
    description:
      "Professional grade slicker brush for detangling and finishing",
    sku: "GP-TOOL-001",
    itemType: "tool",
    measurementUnit: "count",
    currentStock: 6,
  ...
  },
  {
    ...
    brand: "GroomPro",
    category: "tools",
    description: "Heavy-duty nail clippers for all breed sizes",
    sku: "GP-TOOL-002",
    itemType: "tool",
    measurementUnit: "count",
    currentStock: 4,
    ...
    isActive: true,
    condition: "good",
    lastServiced: getDateString(-45),
  },
  {
    id: "prod-021",
    name: 'Straight Scissors 10"',
    brand: "ShearMaster",
    category: "tools",
    description: "Professional straight shears for body and leg work",
    sku: "SM-SHEAR-001",
    itemType: "tool",
    measurementUnit: "count",
    currentStock: 3,
    ...
    unitPrice: 89.99,
    costPrice: 45.0,
    supplier: "ShearMaster Pro",
    lastRestocked: getDateString(-90),
    isActive: true,
    condition: "good",
    lastServiced: getDateString(-15),
  },
  {
    id: "prod-022",
    name: 'Curved Scissors 8"',
    brand: "ShearMaster",
    category: "tools",
    description: "Curved shears for shaping and contouring",
    sku: "SM-SHEAR-002",
    itemType: "tool",
    measurementUnit: "count",
    currentStock: 2,
    ...
    lastServiced: getDateString(-60),
  },
  {
    id: "prod-023",
    name: 'Thinning Scissors 7.5"',
    brand: "ShearMaster",
    category: "tools",
    description: "Blending shears for seamless coat transitions",
    sku: "SM-SHEAR-003",
    itemType: "tool",
    measurementUnit: "count",
    currentStock: 2,
  ...
  },
  {
    ...
    brand: "AndisGroom",
    category: "tools",
    description: "Heavy-duty cordless clipper for all coat types",
    sku: "AG-CLIP-001",
    itemType: "tool",
    measurementUnit: "count",
    currentStock: 4,
    ...
    unitPrice: 149.99,
    costPrice: 75.0,
    supplier: "AndisGroom Supply",
    lastRestocked: getDateString(-120),
    isActive: true,
    condition: "good",
    lastServiced: getDateString(-10),
  },
  {
    id: "prod-025",
    name: "High-Velocity Dryer",
    brand: "MetroVac",
    category: "tools",
    description: "Professional high-velocity dryer for all coat types",
    sku: "MV-DRYER-001",
    itemType: "tool",
    measurementUnit: "count",
    currentStock: 2,
    ...
    unitPrice: 299.99,
    costPrice: 150.0,
    supplier: "MetroVac Pro",
    lastRestocked: getDateString(-180),
    isActive: true,
    condition: "good",
    lastServiced: getDateString(-30),
  },
  // ── Add-on consumables (drawn down by grooming add-ons; seeded low so the
  //    Supply Alerts panel has something to warn about when booked today) ──
  {
    id: "prod-026",
    name: "Enzymatic Pet Toothpaste",
    brand: "FreshBite",
    category: "health",
    description:
      "Poultry-flavored enzymatic toothpaste for teeth-brushing add-on",
    sku: "FB-TOOTH-001",
    itemType: "consumable",
    measurementUnit: "ml",
    currentStock: 180,
    ...
    costPrice: 4.5,
    supplier: "PetPro Supplies",
    lastRestocked: getDateString(-40),
    expiryDate: getDateString(240),
    isActive: true,
  },
  {
    id: "prod-027",
    name: "De-Shedding Furminator Shampoo",
    brand: "FurFresh",
    category: "shampoo",
    description:
      "De-shedding shampoo used for the de-shedding treatment add-on",
    sku: "FF-DSHED-001",
    itemType: "consumable",
    measurementUnit: "ml",
    currentStock: 900,
  ...
  {
    id: "prod-028",
    name: "Anal Gland Cleansing Wipes",
    brand: "VetCare",
    category: "cleaning",
    description: "Single-use wipes for the anal gland expression add-on",
    sku: "VC-GLAND-001",
    itemType: "consumable",
    measurementUnit: "count",
    currentStock: 8,
...
export function getInventoryStats() {
  const active = groomingProducts.filter((p) => p.isActive);
  const consumables = active.filter((p) => p.itemType === "consumable");
  const tools = active.filter((p) => p.itemType === "tool");
  const lowStock = consumables.filter((p) => p.currentStock <= p.minStock);
  const outOfStock = consumables.filter((p) => p.currentStock === 0);
  const toolsNeedingService = tools.filter(
    (p) => p.condition === "needs-service" || p.condition === "retired",
  );
  ...
  return {
    ...
    toolsNeedingService: toolsNeedingService.length,
