...
export const stylists: Stylist[] = [
  ...
  },
  {
    ...
    // Table 83 — Amy overrides the facility defaults: no SMS (email + push
    // instead), summary an hour earlier, and skips the 30-min pings.
    notificationPrefs: {
      types: {
        new_booking: true,
        changes: true,
