...
export const trainingClasses: TrainingClass[] = [
  ...
  // ── Private 1-on-1 coaching offerings (capacity = 1 per session) ──────────
  {
    id: "class-101",
    ...
    classType: "private",
    skillLevel: "beginner",
    dayOfWeek: -1, // not on a fixed weekday — booked individually
    startTime: "09:00",
    endTime: "10:00",
    duration: 60,
    capacity: 1,
...
export const trainingSessions: TrainingSession[] = [
  ...
  // ── Today: a second group class + a private session, so the day view is
  // busy enough to demo both models side by side. ───────────────────────────
  {
    id: "session-004",
    classId: "class-007",
  ...
  },
  {
    ...
    endTime: "15:00",
    status: "scheduled",
    attendees: ["enroll-004"],
    notes: "Focus on loose-leash walking + recall.",
  },
  {
    id: "session-006",
    classId: "class-102",
    ...
    endTime: "17:00",
    status: "scheduled",
    attendees: ["enroll-006"],
    notes: "Continue threshold work — neutral dog at 30ft.",
  },
  {
    id: "session-007",
    classId: "class-101",
...
export const enrollments: Enrollment[] = [
  ...
  // ── Filler enrollments to exercise the capacity-badge states on the day
  // view. Trick Training (class-007) is filled to 8/8 to show the amber Full
  // pill, and Agility Foundations (class-005) is pushed to 6/6 with two
  // waitlisted entries to show the rose +2 wait pill. ─────────────────────
  {
    id: "enroll-013",
    classId: "class-007",
    className: "Trick Training",
  ...
  // Top up Agility Foundations from 3 → 6 enrolled (matches its capacity).
  {
    id: "enroll-021",
    classId: "class-005",
    className: "Agility Foundations",
  ...
  // Two waitlisted entries for Agility Foundations — exercises the rose
  // "waitlist" capacity badge state.
  {
    id: "enroll-024",
    classId: "class-005",
    className: "Agility Foundations",
    ...
    sessionsAttended: 0,
    totalSessions: 8,
    notes: "Waiting on a spot — eager to start.",
  },
  {
    id: "enroll-025",
    classId: "class-005",
...
export const trainerNotes: TrainerNote[] = [
  ...
  // ── Buddy (petId=1) — instructor-only notes so the Notes tab demos with
  // a mix of categories and privacy states. ────────────────────────────────
  {
    id: "note-101",
    ...
    trainerName: "Marcus Chen",
    date: "2026-03-14",
    note: "Buddy gets overstimulated when greeting other dogs near the studio door. Plan to set up a separate entry path on busy nights so we can keep arousal low.",
    category: "behavior",
    isPrivate: true,
  },
  {
    ...
    trainerName: "Marcus Chen",
    date: "2026-03-21",
    note: "Strategy: use food lures longer than usual for the down — Buddy disengages once his focus drops. Pair sessions with a sniff break after every 3-minute drill.",
    category: "general",
    isPrivate: true,
  },
  {
    ...
    trainerName: "Marcus Chen",
    date: "2026-03-28",
    note: "Owner mentioned Buddy is reactive to delivery people at home. Add door desensitization homework next session and keep an eye for similar arousal patterns in class.",
    category: "concern",
    isPrivate: true,
  },
  {
    ...
    trainerName: "Marcus Chen",
    date: "2026-04-04",
    note: "Strong recall under live distraction today — Buddy chose the owner three times in a row past a sniffing dog at 6 feet.",
    category: "achievement",
    isPrivate: false,
  },
  {
    ...
    trainerName: "Marcus Chen",
    date: "2026-05-12",
    note: "Reminder: check harness fit — Buddy is pulling sideways during heel patterns and the chest plate looks rotated. Owner should bring the spare harness next session.",
    category: "general",
    isPrivate: true,
  },
  {
    ...
    trainerName: "Marcus Chen",
    date: "2026-05-13",
    note: "Progressed to out-of-sight down-stays. 30 seconds clean. Ready to start adding short distance work next class.",
    category: "progress",
    isPrivate: false,
  },
];
...
export const trainingPackages: TrainingPackage[] = [
  {
    ...
    disciplineId: "discipline-puppy",
    maxGroupSize: 8,
    imageUrl: "/training/puppy-starter.jpg",
    sortOrder: 1,
  },
  {
    id: "pkg-002",
  ...
  },
  {
    ...
    disciplineId: "discipline-obedience",
    prerequisitePackageIds: ["pkg-002"],
    maxGroupSize: 8,
  ...
  },
  {
    ...
    disciplineId: "discipline-agility",
    maxGroupSize: 6,
    imageUrl: "/training/agility-starter.jpg",
    sortOrder: 4,
  },
  {
    id: "pkg-005",
    ...
    disciplineId: "discipline-behavior",
    maxGroupSize: 4,
    imageUrl: "/training/reactive-dog.jpg",
    sortOrder: 5,
  },
  {
    id: "pkg-006",
    ...
    disciplineId: "discipline-obedience",
    maxGroupSize: 8,
    imageUrl: "/training/trick-training.jpg",
    sortOrder: 6,
  },
  {
    id: "pkg-007",
    ...
    prerequisitePackageIds: ["pkg-002"],
    maxGroupSize: 10,
    imageUrl: "/training/cgc-prep.jpg",
    sortOrder: 7,
  },
  {
    id: "pkg-008",
    ...
    disciplineId: "discipline-agility",
    prerequisitePackageIds: ["pkg-004"],
    maxGroupSize: 6,
    imageUrl: "/training/competition-agility.jpg",
    sortOrder: 8,
  },
];
...
export const trainingAddOns: TrainingAddOn[] = [
  {
    id: "tr-ao-001",
    name: "Private Session Top-Up",
    description:
      "Add a 30-min private session on top of any group class package.",
    price: 45,
    duration: 30,
    isActive: true,
  },
  {
    ...
    description:
      "Written assessment by a certified trainer after evaluating your dog.",
    price: 35,
    duration: 30,
    isActive: true,
  },
  {
    ...
    name: "Training Kit",
    description:
      "Clicker, treat pouch, and training treats for at-home practice.",
    price: 25,
    duration: 0,
    isActive: true,
  },
  {
    ...
    description:
      "Short video recap of your dog's progress sent to you after each session.",
    price: 15,
    duration: 10,
    isActive: true,
  },
  {
    ...
    description:
      "15-min phone or in-person follow-up with the trainer between sessions.",
    price: 20,
    duration: 15,
    isActive: false,
  },
