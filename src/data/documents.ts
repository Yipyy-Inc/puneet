...
export const clientDocuments: ClientDocument[] = [
  ...
  // Signed waivers/agreements for mock customer (clientId 15) — bypass "Complete Required Forms" when testing
  {
    id: "doc-015-liability",
    clientId: 15,
    facilityId: 11,
    type: "waiver",
    ...
    signedByName: "Alice Johnson",
    ipAddress: "192.168.1.45",
    agreedToTerms: ["Liability Release", "Emergency Medical Authorization"],
  },
  {
    id: "doc-015-daycare",
    clientId: 15,
  ...
  },
  {
    ...
    uploadedBy: "Alice Johnson",
    uploadedById: 15,
    uploadedAt: "2024-01-15T10:02:00Z",
    signatureType: "digital",
    signedAt: "2024-01-15T10:02:00Z",
    signedByName: "Alice Johnson",
    ipAddress: "192.168.1.45",
  },
  {
