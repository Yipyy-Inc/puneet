...
export const boardingGuests: BoardingGuest[] = [
  ...
  // Scheduled arrivals for today (not yet checked in)
  {
    id: "bg-020",
    petId: 22,
    petName: "Bailey",
    ...
    emergencyVetContact: "Dr. Patel - (514) 555-7777",
    bookingId: "bk-020",
    checkInDate: "2026-07-19T14:00:00",
    checkOutDate: "2026-07-23T11:00:00",
    kennelId: "K-05",
    kennelName: "Kennel 5 - Standard",
    status: "scheduled",
    packageType: "Standard Kennel",
    ...
    feedingAmount: "2 cups",
    medications: [],
    tags: ["Friendly", "High Energy"],
    notes: "Easygoing. Joins large dog group play.",
  ...
  },
  {
    ...
    emergencyVetContact: "Dr. Nguyen - (514) 555-6666",
    bookingId: "bk-021",
    checkInDate: "2026-07-19T15:00:00",
    checkOutDate: "2026-07-21T11:00:00",
    kennelId: "K-03",
    kennelName: "Kennel 3 - Standard",
    status: "scheduled",
    packageType: "Standard Kennel",
    totalNights: 2,
    nightlyRate: 35,
    ...
    totalPrice: 70,
    allergies: ["Beef"],
    feedingInstructions: "1/2 cup morning and evening",
    foodBrand: "Hill's Science Diet",
    feedingTimes: ["07:30", "18:00"],
    feedingAmount: "1/2 cup",
    medications: [],
    tags: ["Shy"],
    notes: "Timid at first. Give quiet corner kennel.",
  ...
  },
  {
    ...
    emergencyVetContact: "Dr. Wilson - (514) 555-9999",
    bookingId: "bk-022",
    checkInDate: "2026-07-19T16:00:00",
    checkOutDate: "2026-07-26T11:00:00",
    kennelId: "K-15",
    kennelName: "Kennel 15 - Luxury",
    status: "scheduled",
    packageType: "Luxury Suite",
    totalNights: 7,
    nightlyRate: 110,
    ...
    totalPrice: 693,
    allergies: [],
    feedingInstructions: "3 cups morning and evening. Slow feeder bowl.",
    foodBrand: "Blue Buffalo",
    feedingTimes: ["07:30", "18:00"],
    feedingAmount: "3 cups",
    medications: [],
    tags: ["Gentle Giant", "Loves Staff"],
    notes: "Very gentle. Needs the large luxury suite.",
    createdAt: "2026-07-12T11:00:00",
  },
  // Additional current guests staying past today (Current Guests)
  {
    id: "bg-023",
    petId: 25,
    petName: "Duke",
    ...
    petWeight: 100,
    petColor: "Black & Tan",
    petPhotoUrl: "/pets/duke.jpg",
    ownerId: 27,
    ownerName: "Olivia Reed",
    ownerPhone: "(514) 555-0117",
    emergencyVetContact: "Dr. Thompson - (514) 555-8888",
    bookingId: "bk-023",
    checkInDate: "2026-07-18T14:00:00",
    checkOutDate: "2026-07-24T11:00:00",
    actualCheckIn: "2026-07-18T14:20:00",
    kennelId: "K-09",
    kennelName: "Kennel 9 - Premium",
    status: "checked-in",
    packageType: "Premium Suite",
    totalNights: 6,
    nightlyRate: 75,
    ...
    foodBrand: "Purina Pro Plan",
    feedingTimes: ["07:30", "18:00"],
    feedingAmount: "2.5 cups",
    medications: [],
    tags: ["Well Trained", "Calm"],
    notes: "Well behaved. Comfortable in premium suite.",
  ...
  },
  {
    ...
    emergencyVetContact: "Dr. Nguyen - (514) 555-6666",
    bookingId: "bk-024",
    checkInDate: "2026-07-17T14:00:00",
    checkOutDate: "2026-07-22T11:00:00",
    actualCheckIn: "2026-07-17T15:05:00",
    kennelId: "K-04",
    kennelName: "Kennel 4 - Standard",
    status: "checked-in",
    packageType: "Standard Kennel",
    ...
    feedingAmount: "1/2 cup",
    medications: [],
    tags: ["Friendly", "Small Dog Group"],
    notes: "Sweet and social. Joins the small dog group.",
