...
export function getTenantAuditLogs(facilityId: number): TenantAuditLog[] {
  ...
  facilityAuditLogs[11] = [
    ...
    // Client-scoped entries
    {
      ...
      changes: [{ field: "Phone", oldValue: "(514) 555-0101", newValue: "(514) 555-0199" }],
      ipAddress: "192.168.1.22",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
      description: "Updated phone number for Alice Johnson",
    },
    {
      id: "audit-11-c15-02",
      facilityId: 11,
      ...
      entityId: "15",
      entityName: "Alice Johnson",
      changes: [{ field: "Emergency Contact", oldValue: "", newValue: "Robert Johnson (Spouse)" }],
      ipAddress: "192.168.1.10",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
    ...
    // Pet-scoped entries
    {
      ...
      changes: [{ field: "Weight", oldValue: "55 lbs", newValue: "60 lbs" }],
      ipAddress: "192.168.1.22",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
      description: "Updated weight for Buddy from 55 to 60 lbs",
    },
  ];
