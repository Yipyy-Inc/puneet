...
export function getTenantAuditLogs(facilityId: number): TenantAuditLog[] {
  ...
  facilityAuditLogs[11] = [
    ...
    // Client 28 (John Doe) — scoped entries
    {
      ...
      entityId: "28",
      entityName: "John Doe",
      changes: [{ field: "Phone", oldValue: "123-456-0000", newValue: "123-456-7890" }],
      ipAddress: "192.168.1.22",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
    ...
    // Client 29 (Jane Smith) — scoped entries
    {
      ...
      changes: [{ field: "Email", oldValue: "jane@old.com", newValue: "jane@example.com" }],
      ipAddress: "192.168.1.22",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
    ...
    // Pet 14 (Fluffy — Jane Smith's cat) — scoped entries
    {
      ...
      changes: [{ field: "Rabies Vaccine", oldValue: "", newValue: "Expires 2027-06-01" }],
      ipAddress: "192.168.1.10",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
