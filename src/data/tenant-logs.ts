...
export function getTenantAuditLogs(facilityId: number): TenantAuditLog[] {
  ...
  facilityAuditLogs[11] = [
    ...
    // Client 15 (Alice Johnson) — scoped entries
    {
      ...
      changes: [{ field: "Address", oldValue: "122 Main St", newValue: "123 Main Street" }],
      ipAddress: "192.168.1.10",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
    ...
    // Pet 2 (Whiskers — Alice's cat)
    {
      ...
      changes: [{ field: "FVRCP Vaccine", oldValue: "", newValue: "Expires 2027-09-15" }],
      ipAddress: "192.168.1.10",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
    ...
    // Client 16 (Bob Smith)
    {
      ...
      changes: [{ field: "Phone", oldValue: "098-765-0000", newValue: "098-765-4321" }],
      ipAddress: "192.168.1.22",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
    ...
    // Client 20 (Frank Miller)
    {
      ...
      changes: [{ field: "Email", oldValue: "frank@old.com", newValue: "frank@example.com" }],
      ipAddress: "192.168.1.10",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
    ...
    // Pet 7 (Rocky — Grace's dog)
    {
      ...
      changes: [{ field: "Special Needs", oldValue: "None", newValue: "Anxiety — needs quiet area" }],
      ipAddress: "192.168.1.22",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
    ...
    // Client 22 (Henry Wilson)
    {
      ...
      changes: [{ field: "Address", oldValue: "321 Royal Dr", newValue: "321 Royal Drive, Suite 4" }],
      ipAddress: "192.168.1.10",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
    ...
    // Booking-scoped entries
    {
      ...
      changes: [{ field: "Status", oldValue: "Confirmed", newValue: "Checked In" }],
      ipAddress: "192.168.1.22",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
    ...
    },
    {
      ...
      changes: [{ field: "Payment", oldValue: "Pending", newValue: "Paid — $175.91 via Visa ••4242" }],
      ipAddress: "192.168.1.22",
      userAgent: "Mozilla/5.0",
      severity: "Medium",
      status: "Success",
    ...
    },
    {
      ...
      entityId: "7",
      entityName: "Booking #7 — Boarding",
      changes: [{ field: "Status", oldValue: "Checked In", newValue: "Completed" }],
      ipAddress: "192.168.1.22",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
    ...
    },
    {
      ...
      changes: [{ field: "Check-in Time", oldValue: "07:30", newValue: "08:00" }],
      ipAddress: "192.168.1.10",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
    ...
    },
    {
      ...
      changes: [{ field: "Created", oldValue: "", newValue: "Boarding Mar 15-18, Kennel 12" }],
      ipAddress: "192.168.1.5",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
    ...
    },
    {
      ...
      changes: [{ field: "Account", oldValue: "", newValue: "Created as Staff role" }],
      ipAddress: "192.168.1.10",
      userAgent: "Mozilla/5.0",
      severity: "Medium",
      status: "Success",
    ...
    },
    {
      ...
      entityId: "3",
      entityName: "Staff One",
      changes: [{ field: "Schedule", oldValue: "Mon-Fri", newValue: "Mon-Sat" }],
      ipAddress: "192.168.1.5",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
