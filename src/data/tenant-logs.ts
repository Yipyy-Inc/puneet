...
export function getTenantAuditLogs(facilityId: number): TenantAuditLog[] {
  ...
  facilityAuditLogs[11] = [
    ...
    },
    {
      ...
      entityName: "John Doe",
      changes: [
        { field: "Note", oldValue: "", newValue: "Prefers morning drop-off" },
      ],
      ipAddress: "192.168.1.22",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
      description: "Added staff note for John Doe — prefers morning drop-off",
    },
    {
      id: "audit-11-c28-04",
      facilityId: 11,
      ...
      entityId: "28",
      entityName: "John Doe",
      changes: [{ field: "Tag", oldValue: "", newValue: "VIP" }],
      ipAddress: "192.168.1.10",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
      description: "Added VIP tag to John Doe",
    },
    {
      id: "audit-11-c28-05",
      facilityId: 11,
      ...
      severity: "Low",
      status: "Success",
      description: "Updated email for John Doe",
    },
    {
      id: "audit-11-c28-06",
      facilityId: 11,
      ...
      entityId: "28",
      entityName: "John Doe",
      changes: [{ field: "Account", oldValue: "", newValue: "Created" }],
      ipAddress: "192.168.1.5",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
      description: "Created account for John Doe",
    },
    // Client 15 (Alice Johnson) — more entries
    {
      id: "audit-11-c15-03",
      facilityId: 11,
      ...
      changes: [{ field: "Tag", oldValue: "", newValue: "Loyal Customer" }],
      ipAddress: "192.168.1.10",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
      description: "Added Loyal Customer tag to Alice Johnson",
    },
    {
      id: "audit-11-c15-04",
      facilityId: 11,
    ...
    },
    {
      ...
      severity: "Low",
      status: "Success",
      description: "Activated Alice Johnson's account",
    },
    {
      id: "audit-11-c15-06",
      facilityId: 11,
      timestamp: new Date(Date.now() - 300 * 60 * 60 * 1000).toISOString(),
      userId: "user-105",
      userName: "Amy Chen",
      userRole: "Front Desk",
      action: "Created Client",
      ...
      entityName: "Alice Johnson",
      changes: [
        { field: "Account", oldValue: "", newValue: "Created with 2 pets" },
      ],
      ipAddress: "192.168.1.22",
      userAgent: "Mozilla/5.0",
      severity: "Low",
      status: "Success",
      description: "Created account for Alice Johnson with Buddy and Whiskers",
    },
