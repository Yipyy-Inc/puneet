...
| `bun run check:ui-french`              | Fails if a surface a French user reads in English regresses — settings (26 of 50 baselined), all four portal shells and the shadcn primitives (**at zero**) |
