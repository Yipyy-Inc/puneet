...
| `bun run check:ui-french`              | Fails if a surface a French user reads in English regresses. Settings (**all 50 done**), the four portal shells and the shadcn primitives are **at zero**; `staff` was added 2026-09-08 and is ratcheted per file at 725 strings |
