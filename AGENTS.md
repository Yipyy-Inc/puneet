...
| `bun run check:ui-french`              | Fails if a surface a French user reads in English regresses — settings (49 of 50 baselined), the shell and the shadcn primitives (both **at zero**) |
