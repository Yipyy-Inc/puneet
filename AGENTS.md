...
| `bun run check:hardcoded-locale`       | Fails if a formatter is told a locale the user did not choose — §5q. TWO ratchets: 526 told a literal tag, 371 told NOTHING (`toLocaleDateString()`, the machine's locale, added 2026-09-09)                                                                                                                                                                                                                                     |
