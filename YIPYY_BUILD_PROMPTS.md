...
_84 tasks. Build all CRITICAL (1–30) before any HIGH (31–84). Each prompt is independent — paste one at a time and let the agent plan, implement, typecheck, and lint before moving on._
