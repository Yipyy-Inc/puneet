...
The three feedback items are one problem. The facility and employee sidebars are driven by **two different nav definitions**, and the employee one was hand‑authored to _look like_ the facility one but drifted into its own structure:
